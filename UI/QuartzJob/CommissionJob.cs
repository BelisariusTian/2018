...
{
	public class CommissionJob : IJob
	{
		public void Execute(IJobExecutionContext context)
		{
			IApplicationContext ctx = ContextRegistry.GetContext();
			//System.IO.File.AppendAllText(@"d:\Quartz.txt", DateTime.Now + Environment.NewLine + "开始");
			//计算收益
			LogHelper.Writelog($"Quartz在{DateTime.Now}启动了");
			Calculate_earnings(ctx);

		}

		private void ChangeProductState(IApplicationContext ctx)
		{
