...
function getHtml(data) {
    debugger;
    var ulHtml = '<ul class="layui-nav layui-nav-tree " lay-shrink="all" lay-filter="layadmin-system-side-menu" id="LAY-system-side-menu">';
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
            ...
            if (data[i].icon !== undefined && data[i].icon !== '') {
                ulHtml += '<i class="layui-icon layui-icon-template"></i> ';
            ...
            for (var j = 0; j < data[i].children.length; j++) {
                ...
                ulHtml += '<a href="javascript:;" lay-href="' + data[i].children[j].href + '">';
                if (data[i].children[j].icon !== undefined && data[i].children[j].icon !== '') {
                    ulHtml += '<i><img style="width: 18px;" src="' + data[i].children[j].icon + '" /> </i> ';
            ...
            if (data[i].icon !== undefined && data[i].icon !== '') {
                ulHtml += '<i><img style="width: 32px;" src="' + data[i].icon + '" /> </i> ';
                //if (data[i].icon.indexOf('fa-') !== -1) {
                //    ulHtml += '<i class="fa ' + data[i].icon + '" aria-hidden="true" data-icon="' + data[i].icon + '"></i>';
                //} else {
                //    ulHtml += '<i class="layui-icon" data-icon="' + data[i].icon + '">' + data[i].icon + '</i>';
