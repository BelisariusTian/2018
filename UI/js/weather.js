...
GLoc = {
    ...
    geoSuccess: function(position) {
        ...
        g.startPos = position;
        g.searchQuery = 'http://api.openweathermap.org/data/2.5/weather?lat=' + g.startPos.coords.latitude + '&lon=' + g.startPos.coords.longitude + '&appid=7bba1bfdd63feff41616ba8fb768f012';
...
WeatherInfo = {
    ...
    getWeatherData: function(searchQuery) {
        w.searchQuery = 'http://api.openweathermap.org/data/2.5/weather?q=DongGuan,CN&appid=7bba1bfdd63feff41616ba8fb768f012';
